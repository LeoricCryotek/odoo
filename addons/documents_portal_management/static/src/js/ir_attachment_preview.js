odoo.define('documents_portal_management.attachment_preview', function(require) {

    var BasicFields = require('web.basic_fields');
    var DocumentViewer = require('documents_portal_management.IrAttachmentDocumentViewer');
